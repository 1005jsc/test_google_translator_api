  ...
  <ul class="sub_each sub_each_ul clearfix">
    ...
    <li class="left_wrap">
      <h2 class="translation fc_red">
        <span class="translation">우수디자인(GD)</span><span>상품선정</span>
      </h2>
      <p class="sub_tit3 fc_red" style="margin-bottom: 10px">개요</p>
      <p class="txt translation">
        산업통상자원부가 주최하고 한국디자인진흥원이 주관하는
        우수디자인(GD)상품선정은 산업디자인진흥법 제6조에 근거하여 1985년부터
        매년 시행되고 있으며, 공정한 심사를 거쳐 디자인이 우수한 상품에 정부인증
        GD(Good Design) 마크를 부여하는 제도입니다.
      </p>
    </li>
  </ul>
</div>
...
>
  <div class="container">
    ...
    <div class="graph_box graph1">
      ...
      >
      <div class="inner_box">
        <p class="t1 translation">(<span>단위</span> : <span>명</span>)</p>
      ...
      <div class="right">
        ...
        <div class="inner_box">
          ...
          <ul class="graph_list clearfix type2">
            ...
            <li>
              <p class="sort translation">디지털미디어/콘텐츠 디자인</p>
              <p class="bar" data-total="100">
...
-->
  <div class="mb_30">
    <div style="display: flex">
      <p class="sub_tit5 translation">선정 신청 할 수 있는 상품</p>
      <p
        class="translation"
        style="margin-bottom: 12px; margin-left: 10px; color: #9f9f9f"
      >
    ...
    <ul class="bar_list">
      <li>
        우수디자인(GD)상품의 선정을 신청한 날의 2년 전부터 국내 또는 국외에서
        판매 중이거나 판매 예정인 상품
      </li>
      <li>
    ...
    <p class="mb_5 translation">
      * 단, 디자인개발 기업의 경우 상품의 소유권을 가지고 있는 국내외 기업과
      공동 신청하거나 동의를 얻어 신청 가능
    </p>
  </div>
  <div class="mb_30">
    <div style="display: flex">
      <p class="sub_tit5 translation">선정 신청 할 수 없는 상품</p>
      <p
        class="translation"
        style="margin-bottom: 12px; margin-left: 10px; color: #9f9f9f"
      >
    ...
    <ul>
      <li class="mb_5 translation">
        ...
        <br />
        <span class="fc_gray"
          >(특허법, 실용신안법, 디자인보호법, 상표법 및 저작권법 등 국내외 관련
          법규에 의한 법적 분쟁이 있는 상품)
        </span>
      </li>
      <li class="mb_5 translation">
    ...
    <p class="fc_gray translation">
      ※ 선정 신청 후 위 1~4.호에 해당하는 문제가 발견이 되었을 경우 심사탈락 및
      선정 수상을 취소하며, 주최·주관기관에서는 책임을 지지 않습니다.
    </p>
    <p class="fc_gray translation">(* 납부한 선정 심사 요금은 환불 불가)</p>
    <p class="fc_gray translation">
      ※ 분쟁 발생 우려가 있는 상품의 경우 권리보호를 위한 절차 진행 후 신청을
      권고
    </p>
  </div>
</div>
<div class="sub_each tran_box">
  <p class="sub_tit3 translation fc_red">신청 대상 디자인 출품부문(품목)</p>
  <ul class="field_list wow fadeInUp">
    <li>
      ...
      <div class="right">
        <ul class="dot_list">
          <li><em>전기·전자</em><span>가전, 무선통신기기·용품 등 </span></li>
          <li>
            <em>산업기계 및 공구</em><span>산업기기, 제어기, 가공기 등 </span>
          </li>
          <li>
            <em>리빙</em
            ><span
              >완구, 스포츠·레저용품, 위생용품, 생활용품, 문구, 악기, 주방용품,
              사무용품 , 헬스 , 의료기기, 건축설비용품 등
            </span>
          </li>
          <li>
            <em>스타일</em><span>뷰티, 안경, 모자, 시계, 신발, 가방 등 </span>
          </li>
          <li>
            <em>가구</em
            ><span>생활가구, 사무가구, 주방가구, 의료용가구 등 </span>
          </li>
          <li>
            <em>운송기기</em
            ><span>자동차, 요트·선박, 기차, 항공·우주선, 바이크, 드론 등 </span>
          </li>
        </ul>
      </div>
    </li>
    <li>
      ...
      <div class="right">
        <ul class="dot_list">
          ...
          <li>
            <em>패키지 </em
            ><span>POP, 포장, 라벨, 쇼핑백, 박스, 용기, 지기구조 등 </span>
          </li>
          <li><em>브랜드 </em><span>아이덴티티, 상표 등</span></li>
        </ul>
      </div>
    </li>
    <li>
      ...
      <div class="right">
        <ul class="dot_list">
          ...
          <li>
            <em>콘텐츠 </em
            ><span
              >영상(방송, 광고, 영화), 애니메이션, 캐릭터, 사진, 타이포그래피,
              아이콘, 이모티콘, 일러스트레이션, 웹툰 등</span
            >
          </li>
          <li>
            <em>게임 </em><span>온라인·모바일게임, VR·AR·MR 게임 등</span>
          </li>
          <li>
            <em>인터랙션 </em
            ><span>사용자인터페이스(UI), 휴먼인터랙션, HCI 등</span>
          </li>
        </ul>
      </div>
    </li>
      ...
      <div class="right">
        <ul class="dot_list">
          <li>
            <em>실내건축 </em
            ><span
              >실내외 건축, 인테리어, 인테리어장식, 예술장식품, 조명 등</span
            >
          </li>
          <li><em>전시 및 무대 </em><span>전시, 무대, 이벤트 등</span></li>
          <li>
            <em>환경 </em
            ><span>공간, 환경, 공공, 조경 및 레저, 공공시설물, 경관 등</span>
          </li>
        </ul>
      </div>
    </li>
      ...
      <div class="right">
        <ul class="dot_list">
          <li>
            <em>패션 </em
            ><span
              >남성복, 여성복, 유아동복, 모피, 전통복식, 스포츠웨어, 이너웨어
              등</span
            >
          </li>
          <li>
            <em>텍스타일 </em><span>인테리어, 직물, 편물, 프린팅, 섬유 등</span>
          </li>
          <li><em>귀금속·보석 </em><span>주얼리, 패션악세사리 등</span></li>
        </ul>
      </div>
    </li>
    <li>
      ...
      <div class="right">
        <ul class="dot_list">
          <li>
            <em>서비스/경험</em
            ><span
              >보견의료서비스, 여가·레저서비스, 교육서비스, 경험디자인(UX, CX)
              등</span
            >
          </li>
          <li>
            <em>커뮤니티 </em><span>커뮤니티서비스, 공공행정서비스 등</span>
          </li>
          <li><em>엔터테인먼트 </em><span>엔터테인먼트 등</span></li>
        </ul>
      </div>
    </li>
    <li>
...
<div class="sub_each tran_box">
  ...
  <div class="basic_table_box scroll wow fadeInUp">
        ...
        <tr>
          ...
          <td colspan="3" class="inner_tbl">
            <table>
              ...
              <tr>
                <td rowspan="3" style="text-align: left">대통령상</td>
              </tr>
              <tr>
                <td></td>
                <td></td>
        ...
        <tr>
          ...
          <td colspan="3" class="inner_tbl">
            <table>
              ...
              <tr>
                <td rowspan="3" style="text-align: left">국무총리상</td>
              </tr>
              <tr>
                <td></td>
                <td></td>
        ...
        <tr>
          ...
          <td colspan="3" class="inner_tbl">
            <table>
              ...
              <tbody>
                <tr>
                  <td rowspan="4" style="border-right: 1px solid #e1e1e1">
                    은상
                  </td>
                  <td style="border-bottom: 1px solid #e1e1e1">15</td>
                  <td
                    colspan="3"
                    style="border-bottom: 1px solid #e1e1e1; padding: 0"
                  >
                    <table>
                      <colgroup>
                        <col style="width: 40%" />
        ...
        <tr>
          <td colspan="3" class="inner_tbl">
            <table>
              ...
              <tbody>
                <tr>
                  <td style="border-right: 1px solid #e1e1e1" rowspan="4">
                    동상
                  </td>
                  <td>3</td>
                  <td colspan="3" class="inner_tbl">
                ...
                <tr>
                  ...
                  <td colspan="3" class="inner_tbl">
                    <table>
                      ...
                      <tr>
                        <td rowspan="3" style="text-align: left">특허청장상</td>
                      </tr>
                      <tr>
                        <td></td>
                        <td></td>
    ...
    <ul style="margin-top: 10px; line-height: 2">
      <li>※ 상장 발급 기관의 사정에 따라 시상내용 및 수량은 변경 가능</li>
      <li class="fc_red">
        ※ * 중소벤처기업부장관상, 조달청장상은 중소기업에 한하여 시상
      </li>
      <li>
        ※ 유니버설 디자인, 1인 가구를 위한 디자인, 그린 디자인, 인간공학 디자인
        관련 특별상 시상
      </li>
      <li class="fc_red">
        ※ 대상·금상·은상 이상은 시상식 참석, 동상 이하는 시상식 불참석(개별 상장
        우편 발송)
      </li>
    </ul>
  </div>
...
<div class="sub_each tran_box">
  ...
  <table style="width: 100%; table-layout: fixed" class="ta_c basic_table">
    <colgroup>
      <col style="width: 10%" />
      <col style="width: 25%" />
      <col style="width: 25%" />
    ...
    <tr>
      <td
        style="border-right: 1px solid #e1e1e1; border-left: 1px solid #e1e1e1"
      >
        (주 최)
      </td>
      <td
        colspan="4"
        style="text-align: left; padding: 10px; border-right: 1px solid #e1e1e1"
      >
        <img
    ...
    <tr>
      ...
      <td style="text-align: left; border-right: 1px solid #e1e1e1">
        <img
    ...
    <tr>
      ...
      <td style="text-align: left; padding: 10px">이메일 : gd@kidp.or.kr</td>
      <td
        style="text-align: left; padding: 10px; border-right: 1px solid #e1e1e1"
        colspan="2"
      >
...
<div class="sub_each tran_box">
  ...
  <ul class="txt translation" style="word-break: keep-all">
    <li>ㅇ 우수디자인(GD)상품 선정 결과는 일간지 또는 경제지에 공고합니다.</li>
    <li>
      ㅇ GD 홈페이지(https://award.kidp.or.kr)에 온라인 전시 및 게재합니다.
    </li>
    <li>
      ㅇ GD 마크 사용 등 서비스 제공, 사업지원 등 세부지원 내용은 아래와
      같습니다.
    </li>
  </ul>
    ...
    <div class="txt_box">
      <div class="con">
        <p class="t2 translation">
          <span style="font-weight: bold">사용방법</span> ※ 산업디자인진흥법
          시행규칙 제8조 별표(표지·작도법·표시방법) 참조
        </p>
        <p class="t2 translation">
          GD 선정 상품과 당해 상품의 포장, 설명서, 보증서 및 기업 홈페이지 등에
          사용 가능합니다.
        </p>
        <p class="t2 translation">
          단, 선정 당시와 외관이 동일하지 않으면 GD 마크 사용의 정지 혹은 취소
          가능합니다.
        </p>
      </div>
      <div class="con">
        <p class="t2 translation">
          <span style="font-weight: bold">선정증 발급</span> ※ 산업디자인진흥법
          시행규칙 제7조 별지 제2호 서식
        </p>
        <p class="t2 translation">
        ...
        <p class="t2 translation">
          GD 선정 내용(상품명, 브랜드명, 상품설명, 디자이너명 등)은 불가피한
          경우를 제외하고는
        </p>
        <p class="t2 translation">온라인 접수기한 내에만 수정이 가능합니다.</p>
        <!--
...
<div class="sub_each tran_box">
  <ul class="info_ico_list">
    <li class="wow fadeInUp">
      ...
      <div class="txt_box">
        <p class="sub_tit4 translation fc_red">호주 굿디자인 GDA 마크 사용</p>
        <div class="con">
          <p class="t2 translation">
            호주 굿디자인(Good Design Australia, GDA)과의 상호연계로 마크 사용을
            희망할 시
          </p>
          <p class="t2 translation">
    ...
    <li class="wow fadeInUp">
      ...
      <div class="txt_box">
        ...
        <div class="con">
          ...
          <p class="t2 translation">
            GD 선정기업 중 수상기업 (3차 심사 통과)에게는 선정증 및 도록, 상장
            및 트로피가
          </p>
    ...
    <li class="wow fadeInUp">
      ...
      <div class="txt_box">
        ...
        <div class="con">
          ...
          <p class="t2 translation">
            GD 수상 상품은 국내 최대 규모 디자인 박람회인 디자인코리아 2025에
            무료 전시됩니다.
          </p>
          <p class="t2 translation">
            GD 수상 상품은 지역디자인진흥원(RIDP) 및 유관기관 등의 요청에 따라
            수시로 전시됩니다.
          </p>
        </div>
      </div>
    ...
    <li class="wow fadeInUp">
      ...
      <div class="txt_box">
        ...
        <div class="con">
          <p class="t2 translation">
            산업통상자원부 글로벌생활명품 사업 신청 시, ⌜10점의 가점⌟을
            받습니다.
          </p>
          <p class="t2 translation">
            글로벌생활명품 선정 사업: 우수 디자인 생활소비재를 발굴, 프랑스
            메종&오브제 등 디자인 전문 전시 및 수출 상담회 참가, 유통 판로 확대
            등을 지원
          </p>
    ...
    <li class="wow fadeInUp">
      ...
      <div class="txt_box">
        ...
        <div class="con">
          <p class="t2 translation">
            산업통상자원부 글로벌생활명품 사업 신청 시, 10점의 가점을 받습니다.
          </p>
          <p class="t2 translation">
            프랑스 메종&오브제 중심 국내·외 유명 소비재 전문 전시 및 수출 상담회
            참가,
          </p>
          <p class="t2 translation">
            유통 판로 확대 등을 지원하는 글로벌생활명품 선정 제도에 많은 신청
            바랍니다.
          </p>
          <p class="t2 translation" style="font-size: 0.8em">
            * 일정 및 방법은 3월 중 공고 예정
    ...
    <li class="wow fadeInUp">
      ...
      <div class="txt_box">
        <p class="sub_tit4 translation fc_red">
          조달청 중소기업 및 초기중견기업 대상 국가계약법령에 따른 계약체결 후
          수요기관 조달
        </p>
        <div class="con">
          <p class="t2 translation">
            우수조달물품 지정관리 제도 관련 우수제품지정심사에서 GD 선정상품은
            ⌜1점 가점⌟을 받습니다. * 총 가점 3점 중 1점
          </p>
          <p class="t2 translation">
        ...
        <div class="con">
          <p class="t2 translation">우수조달공동상표 물품 지정대상 지정</p>
          <p class="t2 translation">
    ...
    <li class="wow fadeInUp">
      ...
      <div class="txt_box">
        ...
        <div class="con">
          <p class="t2 translation">디자인등록출원 우선 심사 대상 지정</p>
          <p class="t2 translation">
            디자인등록출원을 진행할 시 선정된 상품에 관한 디자인등록출원 우선
            심사 대상으로 지정
          </p>
          <p class="t2 translation">
