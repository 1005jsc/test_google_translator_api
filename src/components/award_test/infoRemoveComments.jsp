            ...
            <ul class="sub_each sub_each_ul clearfix">
              ...
              <li class="left_wrap">
                ...
                <p class="txt translation">
                  ...
                  우수한 상품에 정부인증 GD(Good Design) 마크를 부여하는
                  제도입니다.
                </p>
              </li>
            </ul>
            ...
            <div class="mb_30">
              ...
              <ul>
                <li class="mb_5 translation">
                  ...
                  <br />
                  <span class="fc_gray"
                    >(특허법, 실용신안법, 디자인보호법, 상표법 및 저작권법 등
                    국내외 관련 법규에 의한 법적 분쟁이 있는 상품)
                  </span>
                </li>
                <li class="mb_5 translation">
              ...
              <p class="fc_gray translation">
                ...
                심사탈락 및 선정 수상을 취소하며, 주최·주관기관에서는 책임을
                지지 않습니다.
              </p>
              <p class="fc_gray translation">
                (* 납부한 선정 심사 요금은 환불 불가)
            ...
            <ul class="field_list wow fadeInUp">
              <li>
                ...
                <div class="right">
                  <ul class="dot_list">
                    <li>
                      <em>전기·전자</em><span>가전, 무선통신기기·용품 등 </span>
                    </li>
                    <li>
                      <em>산업기계 및 공구</em
                    ...
                    <li>
                      <em>리빙</em
                      ><span
                        >완구, 스포츠·레저용품, 위생용품, 생활용품, 문구, 악기,
                        주방용품, 사무용품 , 헬스 , 의료기기, 건축설비용품 등
                      </span>
                    </li>
                    <li>
                      <em>스타일</em
                ...
                <div class="right">
                  <ul class="dot_list">
                    <li>
                      <em>실내건축 </em
                      ><span
                        >실내외 건축, 인테리어, 인테리어장식, 예술장식품, 조명
                        등</span
                      >
                    </li>
                    <li>
                      <em>전시 및 무대 </em><span>전시, 무대, 이벤트 등</span>
                    </li>
                    <li>
                      <em>환경 </em
                      ><span
              ...
              <li>
                ...
                <div class="right">
                  <ul class="dot_list">
                    ...
                    <li>
                      <em>귀금속·보석 </em><span>주얼리, 패션악세사리 등</span>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <div class="txt_box">
                <div class="con">
                  <p class="t2 translation">
                    ...
                    산업디자인진흥법 시행규칙 제8조 별표(표지·작도법·표시방법)
                    참조
                  </p>
                  <p class="t2 translation">
                  ...
                  <p class="t2 translation">
                    단, 선정 당시와 외관이 동일하지 않으면 GD 마크 사용의 정지
                    혹은 취소 가능합니다.
                  </p>
                </div>
                <div class="con">
                  ...
                  <p class="t2 translation">
                    GD 선정 내용(상품명, 브랜드명, 상품설명, 디자이너명 등)은
                    불가피한 경우를 제외하고는
                  </p>
                  <p class="t2 translation">
            ...
            <ul class="info_ico_list">
              <li class="wow fadeInUp">
                ...
                <div class="txt_box">
                  ...
                  <div class="con">
                    <p class="t2 translation">
                      호주 굿디자인(Good Design Australia, GDA)과의 상호연계로
                      마크 사용을 희망할 시
                    </p>
                    <p class="t2 translation">
              ...
              <li class="wow fadeInUp">
                ...
                <div class="txt_box">
                  ...
                  <div class="con">
                    ...
                    <p class="t2 translation">
                      GD 선정기업 중 수상기업 (3차 심사 통과)에게는 선정증 및
                      도록, 상장 및 트로피가
                    </p>
              ...
              <li class="wow fadeInUp">
                ...
                <div class="txt_box">
                  ...
                  <div class="con">
                    ...
                    <p class="t2 translation">
                      인터뷰를 요청하는 등 국내외적으로 지속적인 미디어 노출을
                      제공합니다.
                    </p>
                    <p class="t2 translation">
                  ...
                  <div class="con">
                    ...
                    <p class="t2 translation">
                      GD 수상 상품은 국내 최대 규모 디자인 박람회인 디자인코리아
                      2025에 무료 전시됩니다.
                    </p>
                    <p class="t2 translation">
              ...
              <li class="wow fadeInUp">
                ...
                <div class="txt_box">
                  ...
                  <div class="con">
                    ...
                    <p class="t2 translation">
                      글로벌생활명품 선정 사업: 우수 디자인 생활소비재를 발굴,
                      프랑스 메종&오브제 등 디자인 전문 전시 및 수출 상담회
                      참가, 유통 판로 확대 등을 지원
                    </p>
              ...
              <li class="wow fadeInUp">
                ...
                <div class="txt_box">
                  ...
                  <div class="con">
                    <p class="t2 translation">
                      산업통상자원부 글로벌생활명품 사업 신청 시, 10점의 가점을
                      받습니다.
                    </p>
                    <p class="t2 translation">
                      프랑스 메종&오브제 중심 국내·외 유명 소비재 전문 전시 및
                      수출 상담회 참가,
                    </p>
                    <p class="t2 translation">
                      유통 판로 확대 등을 지원하는 글로벌생활명품 선정 제도에
                      많은 신청 바랍니다.
                    </p>
                    <p class="t2 translation" style="font-size: 0.8em">
                      * 일정 및 방법은 3월 중 공고 예정
              ...
              <li class="wow fadeInUp">
                ...
                <div class="txt_box">
                  ...
                  <div class="con">
                    <p class="t2 translation">
                      우수조달물품 지정관리 제도 관련 우수제품지정심사에서 GD
                      선정상품은 ⌜1점 가점⌟을 받습니다. * 총 가점 3점 중 1점
                    </p>
                    <p class="t2 translation">
                  ...
                  <div class="con">
                    ...
                    <p class="t2 translation">
                      「우수조달공동상표 물품 지정 및 관리규정」제1장 제3조 ①항
                      4호 ㉸
                    </p>
                  </div>
                </div>
              ...
              <li class="wow fadeInUp">
                ...
                <div class="txt_box">
                  ...
                  <div class="con">
                    ...
                    <p class="t2 translation">
                      「디자인심사기준」 제5부 심사일반 중 제7장 우선심사 제6조
                      7의 3호
                    </p>
                  </div>
                </div>
